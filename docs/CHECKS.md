...
| 3 | No stock or generated images; empty slots are labelled blocks | pass | 0 images, 0 from other sites, 302 labelled placeholder blocks |
...
| 8 | Every image has alt text; every placeholder block is labelled for a screen reader | pass | 182 labelled blocks; 0 images without alt |
...
| 16 | Every internal link and anchor goes somewhere | pass | 1376 links across 42 pages, and every same-page anchor has its target |
