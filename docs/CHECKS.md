...
| 3 | No stock or generated images; empty slots are labelled blocks | pass | 0 images, 0 from other sites, 193 labelled placeholder blocks |
...
| 8 | Every image has alt text; every placeholder block is labelled for a screen reader | pass | 179 labelled blocks; 0 images without alt |
